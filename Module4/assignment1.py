...
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module4\\Datasets\\stanford_armadillo.ply'
...
def do_PCA(armadillo):
  ...
  pca.fit(armadillo)
  armadillo_new = pca.transform(armadillo)
  
  return armadillo_new
...
def do_RandomizedPCA(armadillo):
  ...
  #
  pca_r = PCA(n_components=2, svd_solver='randomized')
  pca_r.fit(armadillo)
  armadillo_new = pca_r.transform(armadillo)
