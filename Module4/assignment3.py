...
os.chdir('D:\\work\\Courses\\DAT210x-master\\Module4')
...
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module4\\Datasets\\kidney_disease.csv'
...
df = pd.get_dummies(df, columns=['rbc', 'pc', 'pcc', 'ba', 'htn', 'dm',
                                'cad', 'appet', 'pe', 'ane'])
