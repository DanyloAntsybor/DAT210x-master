...
Plot2D(T_iso, "8 IsoMap Variant 0 1", 0, 1)
Plot2D(T_iso, "8 IsoMap Variant 1 2", 1, 2)


iso = manifold.Isomap(n_neighbors=3, n_components=3)
T_iso = iso.fit_transform(df)
Plot2D(T_iso, "3 IsoMap Variant 0 1", 0, 1)
Plot2D(T_iso, "3 IsoMap Variant 1 2", 1, 2)
