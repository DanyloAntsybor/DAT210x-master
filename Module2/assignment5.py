...
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module2\\Datasets\\census.data'
census_names = ['education', 'age', 'capital-gain', 'race', 'capital-loss',
'hours-per-week', 'sex', 'classification']
census = pd.read_csv(filepath, names = census_names, na_values = '?')
...
census['new_education'] = census.education.astype("category",
  ordered=True,
