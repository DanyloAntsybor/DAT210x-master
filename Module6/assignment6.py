...
#
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module6\\Datasets\\dataset-har-PUC-Rio-ugulino.csv'
X = pd.read_csv(filepath, sep = ';', low_memory = False)
