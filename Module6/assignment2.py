...
filepath_tes = 'D:\\work\\Courses\\DAT210x-master\\Module6\\Datasets\\optdigits.tes'
filepath_tra = 'D:\\work\\Courses\\DAT210x-master\\Module6\\Datasets\\optdigits.tra'
X_train, X_test, y_train, y_test = load(filepath_tes, filepath_tra)
...
v_gamma = 0.001
v_kernel = 'rbf'
model = SVC(kernel=v_kernel, C = v_C, gamma = v_gamma)
