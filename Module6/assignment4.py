...
#
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module6\\Datasets\\wheat.data'
...
dectree = tree.DecisionTreeClassifier(max_depth=9, random_state = 2)
...
benchmark(dectree, X_train, X_test, y_train, y_test, 'Decision Tree')
drawPlots(dectree, X_train, X_test, y_train, y_test, 'Decision Tree')
