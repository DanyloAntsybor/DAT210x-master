...
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module4\\Datasets\\face_data.mat'
...
# loaded it correctly.
#
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module5\\Datasets\\face_labels.csv'
face_labels = pd.read_csv(filepath, header = None, names = ["facelabel"])
facelabel = face_labels.facelabel.copy()
...
X_train, X_test, y_train, y_test = train_test_split(df, facelabel, test_size=0.15, random_state=7)
...
Plot2DBoundary(knn, X_train, y_train, X_test, y_test)
