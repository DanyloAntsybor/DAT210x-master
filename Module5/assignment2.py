...
#
users_id = df["In"].unique()
users_id = users_id.tolist()
...
df_for_kmean = user1.loc[:,['TowerLon','TowerLat']]
model = KMeans(n_clusters=2)
model.fit(df_for_kmean)

centroids = model.cluster_centers_
print(centroids)
ax.scatter(centroids[:,0],centroids[:,1], c='red', marker='X', alpha=0.5)
