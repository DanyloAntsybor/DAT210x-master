...
#
folderpath = 'D:\\work\\Courses\\DAT210x-master\\Module5\\Datasets\\Audio\\Zeros'
...
sample_rate = sample_rate_list[random_idx]
wavfile.write(folderpath + '\\' + 'Original Test Clip.wav', sample_rate, test)
...
#
test_feat = int(Provided_Portion * n_audio_samples)
...
#
X_train = train[:,:test_feat]
y_train = train[:,test_feat:]
...
wavfile.write(folderpath + '\\' + 'Extrapolated Clip.wav', sample_rate, completed_clip[0])
