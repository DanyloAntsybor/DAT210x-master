...
# called X:
#
filepath = 'D:\\work\\Courses\\DAT210x-master\\Module5\\Datasets\\College_new.csv'
...
y_accept = X['Accept']
X_board = X[['Room.Board']]

from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(X_board, y_accept, test_size=0.3, random_state=7)
...
#
X_enroll = X[['Enroll']]
X_train, X_test, y_train, y_test = train_test_split(X_enroll, y_accept, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
#
X_f_undergrad = X[['F.Undergrad']]
X_train, X_test, y_train, y_test = train_test_split(X_f_undergrad, y_accept, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
#
X_combination = X[['Room.Board','Enroll']]
X_train, X_test, y_train, y_test = train_test_split(X_combination, y_accept, test_size=0.3, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
